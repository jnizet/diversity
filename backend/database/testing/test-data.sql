...
--     Home
    ...
    (16, 1, 'IMAGE', 'carousel.images.3.image', null, 300, 'Légende n°4', null, false),
    (17, 1, 'TEXT', 'carousel.territoriesButton', 'Découvrir les territoires', null, null, null, false),
    (18, 1, 'TEXT', 'presentation.title', 'Le compteur de biodiversité Outre-Mer', null, null, null, false),
    (19, 1, 'TEXT', 'presentation.text', 'Les territoires d''outre-mer présentent une biodiversité particulièrement riche et variée, ...', null, null, null, false),
    (20, 1, 'TEXT', 'testimony.title', 'Une biodiversité unique et fragile, protégeons-la !', null, null, null, false),
    (21, 1, 'TEXT', 'testimony.text', 'La conservation de la biodiversité dépend de sa connaissance et de la compréhension des phénomènes qui l''impactent. Les indicateurs sont des outils qui permettent de suivre différents paramètres de la biodiversité, pour renseigner de son évolution.', null, null, null, false),
    (22, 1, 'TEXT', 'testimony.quote', 'Ces actions conjuguées entraînent un accroissement de la biodiversité, une amélioration de la qualité de l''eau, de l''air mais aussi de la qualité de vie.', null, null, null, false),
