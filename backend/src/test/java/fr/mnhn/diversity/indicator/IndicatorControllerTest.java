...
class IndicatorControllerTest extends ControllerTest {
    ...
    void prepare() {
        ...
        Indicator invasiveSpecies = new Indicator(1L, "i1", "especes-envahissantes", false, 1,
            List.of(category1, category2), List.of(ecogesture));
        Indicator deforestation = new Indicator(2L, "i2", "deforestation", false, 2,
            List.of(category2, category3), List.of());
        Indicator notExisting = new Indicator(3L, "i3", "not-existing", false, 3, List.of(category3), List.of());
