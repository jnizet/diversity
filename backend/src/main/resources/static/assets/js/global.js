...
$(document).ready(function() {
    ...
    function open_menu() {
        ...
        TweenLite.to(".l1", .25, { attr: { x1: 3, y1: 3, x2: 19, y2: 19 }, ease: "cache", overwrite: "all" });
        TweenLite.to(".l3", .25, { attr: { x1: 3, y1: 19, x2: 19, y2: 3 }, ease: "cache", overwrite: "all" });
    ...
    function close_menu() {
        ...
        TweenLite.to(".l1", .25, { attr: { x1: 1, y1: 3, x2: 21, y2: 3 }, ease: "cache", overwrite: "all" });
        TweenLite.to(".l3", .25, { attr: { x1: 1, y1: 19, x2: 10, y2: 19 }, ease: "cache", overwrite: "all" });
    ...
    function anim_menu() {
        if (!$('body').hasClass('menu-open')) {
            TweenMax.to($('.l3'), .5, { xPercent: 120 });
            TweenMax.to($('.l3'), .5, { xPercent: 0, delay: .5 });
        }
    }
    ...
    $('.apprendre-top').on('click', function() {
        ...
        if (!$(this).parent().hasClass('closed')) {
            ...
            $(this).parent().find('.apprendre-bottom').css('height', $(this).parent().find('.apprendre-bottom').prop('scrollHeight') + 20);
        }
    })
