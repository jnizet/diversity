...
public final class IndicatorModel {
    ...
    public static final PageModel INDICATOR_PAGE_MODEL =
        PageModel.builder("indicator")
            ...
            // Présentation
            .section(
                SectionElement.builder("presentation").describedAs("Présentation de l'indicateur")
                    .text("description", "Description de l'indicateur - pages indicateurs")
                    .text("descriptionTerritories",
                        "Description de l'indicateur - pages territoires")
                    .multiSizeImage("image", "Illustration de l'indicateur")
                    .checkbox("shadowed", "Ajouter une ombre sur le coté gauche de la photo")
                    .select("sourceSelect", "Choix du logo source",
                        Map.of("onb", "ONB", "inpn", "INPN"))
            ...
            .section(SectionElement.builder("understand").describedAs("Comprendre l'indicateur")
                ...
                .link("article",
                    "Lien vers un article (si aucun article n'est disponnible replir les champs avec la valeur 'aucun') ")
    ...
    /**
     * The model of the indicator home page. To display this page, this model is not sufficient: it
     * also displays indicator cards and their categories, and these cards are created using the
     * {@link #INDICATOR_PAGE_MODEL}
     */
    public static final PageModel INDICATOR_HOME_PAGE_MODEL =
        PageModel.builder("indicators")
            ...
            .section(
                SectionElement.builder("onb")
                    .describedAs("Observatoire national de la biodiversité")
                    .titleText("title", "Titre")
                    .multiLineText("description", "Description de l'observatoire'")
                    .link("link", "Lien vers l'observatoire")
            )
            .section(
                SectionElement.builder("inpn")
                    .describedAs("Inventaire national du patrimoine naturel")
                    .titleText("title", "Titre")
