    ...
    public void run(String... args) {
        ...
        Operation reunionElements =
            insertInto("page_element")
                ...
                .withGeneratedValue("id", elementIdGenerator)
                .columns("type", "key", "text", "image_id", "alt", "href", "title")
                .values(TEXT, "zoom.title", "La Réunion, entre mer et montagnes", null, null, null, true)
                .values(TEXT, "zoom.callToAction", "La Réunion, entre mer et montagnes", null, null, null, true)
                .values(IMAGE, "zoom.map", null, 106, "Infographie Réunion", null, false)
