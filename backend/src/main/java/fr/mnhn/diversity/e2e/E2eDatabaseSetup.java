    ...
    public void run(String... args) {
        ...
        Operation homeElements =
            insertInto("page_element")
                ...
                .values(CHECKBOX, "carousel.images.0.shadowed", true, null, null, null, false)
                .values(IMAGE, "carousel.images.1.image", null, 2L, "Légende n°2", null, false)
                .values(CHECKBOX, "carousel.images.1.shadowed", true, null, null, null, false)
                .values(IMAGE, "carousel.images.2.image", null, 3L, "Légende n°3", null, false)
                .values(CHECKBOX, "carousel.images.2.shadowed", true, null, null, null, false)
                .values(IMAGE, "carousel.images.3.image", null, 300L, "Légende n°4", null, false)
                .values(CHECKBOX, "carousel.images.3.shadowed", true, null, null, null, false)
